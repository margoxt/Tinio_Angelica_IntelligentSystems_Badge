...
# Get from text_recognition folder and import the functions
...
# Get from image_recognition folder and import the functions
...
def run_image_model(image_path, lexicon):
...
def main():
    ...
    if args.text:
        ...
        output = run_image_model(args.image, lexicon)
